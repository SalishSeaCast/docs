...
Note: if you have chosen to store XIOS in a different directory (i.e. :file:`/ocean/$USER/MEOPAR//XIOS`) then you need to create a symbolic link to :file:`/data/$USER/MEOPAR//XIOS`.
