...
The AMM12-BDY-analysis.ipynb IPython Notebook is an analysis of the differences in results obtained from runs of the AMM12 configuration with the unstructured boundaries
