...
*	`New Westminster <http://www.meds-sdmm.dfo-mpo.gc.ca/isdm-gdsi/twl-mne/inventory-inventaire/sd-ds-eng.asp?no=7654&user=isdm-gdsi&region=PAC>`_ (7654, ??min, year1, year2, numdays)
...
*	`Victoria Harbour <http://www.meds-sdmm.dfo-mpo.gc.ca/isdm-gdsi/twl-mne/inventory-inventaire/sd-ds-eng.asp?no=7120&user=isdm-gdsi&region=PAC&ref=maps-cartes>`_ (7120, 60min, 1963, present, 18535, yes)
...
*	`Winter Harbour <>`_ (8735, ??min, year1, year2, numdays)
...
*	`Port Hardy <>`_ (8408, ??min, year1, year2, numdays)
